...
export const projects: Project[] = [
  {
    ...
    description:
      'Enterprise pricing management that brings rate card setup, line items, premium adjustments, and publishing into one clearer workflow. Built as an interactive coded prototype.',
    category: 'Enterprise UX · Pricing · Interactive Prototype',
